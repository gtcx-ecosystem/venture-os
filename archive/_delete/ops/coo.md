...
# COO connection — venture-os

**fabric-os** is the tactical **Chief Operating Officer** of the GTCX ecosystem. This repo participates via `ops/` — local consumption only.
