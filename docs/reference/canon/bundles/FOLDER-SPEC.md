---
title: 'reference/canon/bundles/ — folder provisioning'
status: current
date: 2026-06-15
owner: venture-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'reference/canon/bundles']
review_cycle: on-change
---

# `docs/reference/canon/bundles/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

reference/canon/bundles/ narrative and specs for venture-os.
