---
title: 'operations/workflows/ — folder provisioning'
status: current
date: 2026-06-15
owner: venture-os
document_type: folder-spec
tier: operating
tags: ['documentation', 'operations/workflows']
review_cycle: on-change
---

# `docs/operations/workflows/` — provisioning

> **Parent:** [`docs/FOLDER-SPEC.md`](../FOLDER-SPEC.md)

## Purpose

operations/workflows/ narrative and specs for venture-os.
