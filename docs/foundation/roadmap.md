---
title: 'venture-os — executive roadmap'
status: current
date: 2026-06-16
owner: venture-os
...
Next.js app routes green (lint/build); product-goals + PRD indexed; pilot client schema validated
